...
class LibraryTest(TestCase):
    def setUp(self):
        test_user1 = User.objects.create_user(username='user1',email='user.1@mail.ru',password='1qaz',first_name='User',last_name='Userov')
        test_user2 = User.objects.create_user(username='user2',email='user.2@mail.ru',password='2wsx',first_name='Usera',last_name='Userovna')
        test_user1.save()
        test_user2.save()
...
#search_book		
    ...
    def test_search_book_logged_in_correct_get_request(self):
        login = self.client.login(username='user1', password='1qaz')
        resp = self.client.get('/library/search_book/')
...
'''		
    def test_registration(self):
        ...
        resp = self.client.post(reverse('registration'), {'username': 'katushka', 'password': '1qaz', 'first_name': 'Katushka', 'last_name': 'Pushka', 'email': 'margauser1.kopyova@mail.ru'})
        self.assertEqual(resp.status_code, 200)
